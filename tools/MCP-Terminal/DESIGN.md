...
MCP-Terminal should provide controlled network remote-access operations through MCP.
...
```json
{
  "ok": true,
  "tool": "mcp-terminal",
  "command": "terminal_ssh_exec",
  "profileId": "lab-linux-01",
  "host": "192.168.1.50",
  "exitCode": 0,
  "stdoutPath": "C:\\ProgramData\\VTX-MCP\\MCP-Hub\\jobs\\job-001\\output\\ssh-stdout.txt",
  "stderrPath": "C:\\ProgramData\\VTX-MCP\\MCP-Hub\\jobs\\job-001\\output\\ssh-stderr.txt",
...
interactive session viewer in Hub
